...
@section('breadcrumb')
    <div class="row page-title">
        <div class="col-md-12">
            ...
            <h4 class="mb-1 mt-0">Cash Withdrawal</h4>
        </div>
    </div>
@endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <h4 class="header-title mt-0 mb-1">Make Cash Withdrawal</h4>
                        </div>
                    </div>
                    <hr/>
                    <div class="row">
                        <h6 class="ml-2 text-info"><i>* Complete form below to withdraw</i></h6>
