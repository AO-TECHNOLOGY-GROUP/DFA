                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <button href="#captureFingerprints" data-toggle="modal"
                                            class="btn code-dialog dropdown-item text-primary">Complete Process</button>
                                        <form action="{{ route('account.action-accounts') }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="name" value="{{ $account->name }}" />
                                            <input type="hidden" name="account_number"
                                                value="{{ $account->accontNumber }}" />
                                            <input type="hidden" name="phone_number"
                                                value="{{ $account->phoneNumber }}" />
                                            <input type="hidden" name="status" value="4" />
                                            <button type="submit"
                                                class="btn code-dialog dropdown-item text-success">Approve
                                                Account</button>
                                        </form>
                                        <form action="{{ route('account.action-accounts') }}" method="POST">
                                            @csrf
                                            ...
                                            <button type="submit"
                                                class="btn code-dialog dropdown-item text-danger">Reject
                                                Account</button>
                                        </form>
...
function captureFingerprint(event, finger, id) {
    ...
    var client_ip = $.getJSON("https://api.ipify.org");
    ...
    const url = "https://7cc0-105-161-145-98.ngrok.io/channelinterface/req";
