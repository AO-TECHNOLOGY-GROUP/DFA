        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="table-responsive">
                    @if (count($data))
                        <table class="table-hover table m-0 align-items-center table-flush table-sm table-small-font"
                            width="100%">
                            <thead>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <form method="POST" action="{{ route('loan.action-loan') }}">
                                                        @csrf
                                                       <input type="hidden" value={{ $loan->id }} name="loan_id">
                                                        <input type="hidden" name="name" value="{{ $loan->name }}"/>
                                                        <input type="hidden" name="phone_number" value="{{ $loan->phoneNumber }}"/>
